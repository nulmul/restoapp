...
const menuItems = [
  {
    ...
    name: 'Bruschetta',
    description:
      'Grilled bread rubbed with garlic and topped with olive oil, salt, tomato, and fresh basil',
    price: 8.99,
    category: 'starters',
    image:
  ...
  },
  {
    ...
    category: 'starters',
    image:
      'https://images.unsplash.com/photo-1608797178974-15b35a64ede9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80',
  },
  {
    id: 3,
    name: 'Filet Mignon',
    description:
      '8oz center-cut beef tenderloin, served with roasted vegetables and mashed potatoes',
    price: 28.99,
    category: 'mains',
    image:
  ...
  },
  {
    ...
    name: 'Grilled Salmon',
    description:
      'Fresh Atlantic salmon fillet, grilled and served with seasonal vegetables and lemon butter sauce',
    price: 22.99,
    category: 'mains',
    image:
  ...
  },
  {
    ...
    category: 'drinks',
    image:
      'https://images.pexels.com/photos/17494021/pexels-photo-17494021.jpeg',
  },
];
...
const Menu = () => {
  ...
  return (
    <section id="menu" className="py-16 bg-gray-800 w-full">
